package com.example.spring_crud_boot.config.security;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin()
                ...
                .permitAll()
                .and().formLogin();//стандартная спринговская форма логина
        ...
        http.logout()
                ...
                .and().formLogin() //стандартная спринговская форма логина при логауте
